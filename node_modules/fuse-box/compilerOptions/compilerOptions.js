...
const getExtendedTsConfig_1 = require("./getExtendedTsConfig");
    ...
    if (tsConfigPath) {
        ...
        if (tsConfig) {
            ...
            if (tsConfig.extends) {
                 ...
                 */
                const [extendedData, extendedPath] = getExtendedTsConfig_1.getExtendedTsConfig(data, tsConfigDirectory);
                if (extendedData.error) {
                    let message = 'Error while initializing tsconfig';
                    ctx.fatal('tsconfig extends error', [extendedData.error.messageText || message]);
                }
                const extendedOptions = (_a = extendedData.config) === null || _a === void 0 ? void 0 : _a.compilerOptions;
                if (extendedOptions) {
